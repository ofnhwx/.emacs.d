...
(defun custom-misc/init-codic () (use-package codic :no-require t))
(defun custom-misc/init-dired-toggle-sudo () (use-package dired-toggle-sudo :no-require t))
(defun custom-misc/init-leaf () (use-package leaf :no-require t))
(defun custom-misc/init-pacfiles-mode () (use-package pacfiles-mode :no-require t))
(defun custom-misc/init-sqlite3 () (use-package sqlite3 :no-require t))
(defun custom-misc/init-vlf () (use-package vlf :no-require t))
(defun custom-misc/init-yarn () (use-package yarn :no-require t))

(defun custom-misc/init-apheleia ()
...
(defun custom-misc/init-ddskk-posframe ()
...
(defun custom-misc/init-dired-filter ()
  (use-package dired-filter
    :hook (dired-mode . dired-filter-mode)))

(defun custom-misc/init-elisp-demos ()
...
(defun custom-misc/init-flycheck-posframe ()
  (use-package flycheck-posframe
    :hook (flycheck-mode . flycheck-posframe-mode)))

(defun custom-misc/init-grugru ()
  (use-package grugru
    :defer t
    :init
    (spacemacs/set-leader-keys "xgg" #'grugru)))

(defun custom-misc/init-helpful ()
  (use-package helpful
    :defer (spacemacs/defer)
    :init
...
(defun custom-misc/init-highlight-indent-guides ()
...
(defun custom-misc/init-ob-typescript ()
...
(defun custom-misc/init-wakatime-mode ()
