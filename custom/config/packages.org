...
* dired+
  ...
  (use-package dired+
    :after (dired)
    :init
    (set-variable 'diredp-bind-problematic-terminal-keys nil)
    (set-variable 'diredp-hide-details-initially-flag nil)
    (set-variable 'diredp-hide-details-propagate-flag nil))
  #+end_src
* dired-filter
  #+begin_src emacs-lisp
